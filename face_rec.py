...
hostname = 'redis-13223.c246.us-east-1-4.ec2.redns.redis-cloud.com'
portnumber = 13223
password = 'Vongola99'
...
def retrive_data(name):  # Fixed function name
    ...
    return retrive_df[['Name', 'Role', 'facial_features']]  # Removed extra space
...
#Need to save log for every 1 mins
class RealTimePred:
    def __init__(self):
    ...
    # Step 3: Push data to Redis
        ...
        for name, role, ctime in zip(name_list, role_list, ctime_list):
            if name != 'Unknown':
                ...
                r.lpush('attendance:logs', concat_string)  # Store as a string
    ...
    def face_prediction(self,test_image, dataframe, feature_column, 
        ...
        #step1 :take test img and apply to insight face
...
class RegistrationForm:
    ...
    def save_data_in_redis_db(self,name,role):
        ...
        #step 4 savie this into redis database
        #redis hashes
